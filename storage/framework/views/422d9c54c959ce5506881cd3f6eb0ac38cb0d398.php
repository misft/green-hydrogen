...
<body class="<?php if(url()->current() == route('button-builder')): ?>  button-builder <?php endif; ?>">
    ...
    <div class="page-wrapper">
        ...
        <div class="page-body-wrapper">
            ...
            <!-- Page Sidebar Ends-->
            <!-- Right sidebar Start-->
            <?php echo $__env->make('layouts.chat_sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <!-- Right sidebar Ends-->
            <div class="page-body">
...
<?php /**PATH D:\Projects\new-green-hydrogen\resources\views/layouts/master.blade.php ENDPATH**/ ?>