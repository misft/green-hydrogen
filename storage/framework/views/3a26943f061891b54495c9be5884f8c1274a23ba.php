    ...
    <div class="main-header-right">
        <div class="main-header-left text-center">
            <div class="logo-wrapper"><a href="<?php echo e(route('/')); ?>"><img
                        src="<?php echo e(route('/')); ?>/assets/images/logo/logo.png" alt=""></a></div>
        </div>
        ...
        <div class="nav-right col pull-right right-menu">
            <ul class="nav-menus">
                ...
                <li class="onhover-dropdown"><img class="img-fluid img-shadow-warning"
                        src="<?php echo e(route('/')); ?>/assets/images/dashboard/bookmark.png" alt="">
                ...
                <li class="onhover-dropdown"><img class="img-fluid img-shadow-secondary"
                        src="<?php echo e(route('/')); ?>/assets/images/dashboard/like.png" alt="">
                ...
                <li class="onhover-dropdown"><img class="img-fluid img-shadow-warning"
                        src="<?php echo e(route('/')); ?>/assets/images/dashboard/notification.png" alt="">
                ...
                <li><a class="right_side_toggle" href="#"><img class="img-fluid img-shadow-success"
                            src="<?php echo e(route('/')); ?>/assets/images/dashboard/chat.png" alt=""></a></li>
                <li class="onhover-dropdown"> <span class="media user-header"><img class="img-fluid"
                            src="<?php echo e(route('/')); ?>/assets/images/dashboard/user.png" alt=""></span>
...
<?php /**PATH D:\Projects\new-green-hydrogen\resources\views/layouts/header.blade.php ENDPATH**/ ?>