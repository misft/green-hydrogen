        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <x-action.create-button :route="route('news.create')" />
                                ...
                                <tbody>
                                    @foreach ($news as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <x-action.delete-row :idform="$item->id" :action="route('news.destroy', $item->id)" />
                                                <x-action.edit-row :route="route('news.edit', $item->id)" />
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
