...
@section('breadcrumb-title')
    <h2>Project Category<span> Management</span></h2>
@endsection
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <x-action.create-button :route="route('project_category.create')" />
                                ...
                                <tbody>
                                    @foreach ($categories as $item)
                                        <tr>
                                            ...
                                            <td class="col-4">
                                                <x-action.delete-row :action="route('project_category.destroy', $item->id)" />
                                                <x-action.edit-row :route="route('project_category.edit', $item->id)" />
                                                </td>
                                            </div>
                                        </tr>
                                    @endforeach
