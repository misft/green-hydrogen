            ...
            <div class="col-xl-4 xl-50 box-col-12">
                <div class="card gradient-secondary o-hidden monthly-overview">
                    ...
                    <div class="card-body p-0">
                        ...
                        <span class="overview-dots full-lg-dots"><span class="dots-group"><span
                                    class="dots dots1"></span><span class="dots dots2 dot-small"></span><span
            ...
            <div class="col-xl-4 xl-100 box-col-6">
                <div class="card gradient-primary o-hidden monthly-overview yearly">
                    ...
                    <div class="card-body p-0">
                        ...
                        <span class="overview-dots full-width-dots"><span class="dots-group"><span
                                    class="dots dots1"></span><span class="dots dots2 dot-small"></span><span
                                    class="dots dots3 dot-small"></span><span class="dots dots4 dot-medium"></span><span
                                    class="dots dots5 dot-small"></span><span class="dots dots6 dot-small"></span><span
                                    class="dots dots7 dot-small-semi"></span><span
            ...
            <div class="col-xl-6 xl-100 box-col-12">
                <div class="card weather-bg">
                    ...
                    <div class="card-body weather-bottom-bg p-0">
                        ...
                        <img class="img-fluid" src="{{ route('/') }}/assets/images/dashboard/weather-image.png"
                            alt="">
                    </div>
                </div>
            </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="activity-image"><img class="img-fluid"
                                                    src="{{ route('/') }}/assets/images/dashboard/clipboard.png" alt="">
                                            </div>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="activity-image activity-secondary"><img class="img-fluid"
                                                    src="{{ route('/') }}/assets/images/dashboard/greeting.png" alt="">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="activity-details">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="recent-images"><img class="img-fluid"
                                                    src="{{ route('/') }}/assets/images/dashboard/recent-user-1.png"
                                                    alt=""></div>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="recent-images-primary"><img class="img-fluid"
                                                    src="{{ route('/') }}/assets/images/dashboard/recent-user-2.png"
                                                    alt=""></div>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="recent-images-secondary"><img class="img-fluid"
                                                    src="{{ route('/') }}/assets/images/dashboard/recent-user-3.png"
                                                    alt=""></div>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="recent-images-warning"><img class="img-fluid"
                                                    src="{{ route('/') }}/assets/images/dashboard/recent-user-4.png"
                                                    alt=""></div>
                                        </td>
                                        <td>
