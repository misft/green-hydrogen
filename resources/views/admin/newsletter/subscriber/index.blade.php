...
@section('breadcrumb-title')
    <h2>Newsletter<span> Management</span></h2>
@endsection
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <x-action.create-button :route="route('subscriber.create')" />
                                ...
                                <tbody>
                                    @foreach ($subscriber as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <x-action.subscriber-act-deact :idform="'act-deact' . $item->id" :value="$item->is_active" :action="route('subscriber.update', $item->id)" :email="$item->email" />
                                                <x-action.delete-row :idform="$item->id" :action="route('subscriber.destroy', $item->id)" />
                                                <x-action.edit-row :route="route('subscriber.edit', $item->id)" />
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
