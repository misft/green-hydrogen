        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <x-action.create-button :route="route('newsletter.create')" />
                                ...
                                <tbody>
                                    @foreach ($newsletter as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <x-action.delete-row :idform="$item->id" :action="route('newsletter.destroy', $item->id)" />
                                                <a href="{{ route('newsletter.show', $item->id) }}" class="btn mb-1 btn-success btn-sm btn-pill" title="">Show</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
