...
@section('breadcrumb-title')
    <h2>City<span> Management</span></h2>
@endsection
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <x-action.create-button :route="route('city.create')" />
                                ...
                                <tbody>
                                    @foreach ($city as $item)
                                        <tr>
                                            ...
                                            <td class="col-4">
                                                <x-action.delete-row :idform="$item->id" :action="route('city.destroy', $item->id)" />
                                                <x-action.edit-row :route="route('city.edit', $item->id)" />
                                                </td>
                                            </div>
                                        </tr>
                                    @endforeach
