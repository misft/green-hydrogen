...
<div>
    <div class="form-group">
        ...
        <div class="row">
            <div class="col-6">
                <x-form.text id="lat-{{ $identifier }}-input" oninput="onInput{{ $identifier }}Maps(event)" value="{{ $lat }}" name="{{ $latName }}" placeholder="Latitude" label=""></x-form.text>
            </div>
            <div class="col-6">
                <x-form.text id="lng-{{ $identifier }}-input" oninput="onInput{{ $identifier }}Maps(event)" value="{{ $lng }}" name="{{ $lngName }}" placeholder="Longitude" label=""></x-form.text>
            </div>
        </div>
    </div>
</div>
